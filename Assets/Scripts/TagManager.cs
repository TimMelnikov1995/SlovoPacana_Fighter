...
{
    public const string HORIZONTAL_MOVEMENT = "Horizontal Movement";
    public const string VERTICAL_MOVEMENT = "Vertical Movement";
...
public class Tags
{
    public const string ON_FLOOR_TAG = "On Floor";
